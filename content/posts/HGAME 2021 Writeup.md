...
![img](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed/img/20210214230828.png)

题目是一个记事本，添加描述的时候存在SSTI，在查看页面可以看到SSTI已经成功了：

![image-20210214230953251](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed/img/20210214230954.png)
...
![image-20210215130849132](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed/img/20210215130850.png)
...
![image-20210215131110567](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed/img/20210215131112.png)
...
![image-20210215131033385](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed/img/20210215131035.png)
...
![image-20210215121933780](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed/img/20210215121944.png)
...
![image-20210215130722662](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed/img/20210215130724.png)
...
![image-20210216130624020](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed/img/20210216130625.png)
...
![image-20210216125152416](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed/img/20210216125153.png)
...
![image-20210216124754639](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed/img/20210216124755.png)
...
![image-20210216124651414](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed/img/20210216124700.png)
...
1. 增加了HttpOnly，使得我们直接用js不能直接获取到本地cookie；
   ...
   ![image-20210220173619352](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed/img/20210220173620.png)

2. 修改了功能，把直接替换字符串换成了查找字符串

   ![image-20210220173856459](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed/img/20210220173858.png)
...
![image-20210220174348492](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed/img/20210220174349.png)

如果按照正常思维来查找'a'字符串的话，效果就如下图：

![image-20210220174510622](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed/img/20210220174512.png)

但是我们应当注意到，这个高亮实际上还是由`String.prototype.replace()`方法来进行**正则替换**的，那么我们如果输入`.*`之类的关键词进行高亮就会出现意想不到的效果：
![image-20210220174752450](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed/img/20210220174753.png)
...
![image-20210220175913943](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed/img/20210220175915.png)
...
![image-20210220172727362](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed/img/20210220172735.png)

大手一抖，flag到手：

![image-20210220175430475](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed/img/20210220175431.png)

因为flag里面出题人故意放了`&`字符让我们踩坑，打出来的responseText需要base64编码。

![image-20210220172930232](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed/img/20210220175441.png)

下面这个才对。

![image-20210220173313149](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed/img/20210220175445.png)