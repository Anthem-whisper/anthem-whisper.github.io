...
![CC.png](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed/img/202109191531135.png)
...
![image-20210726103357827](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed/img/202109191520228.png)

最终在这里产生了DNS请求

![image-20210726104033123](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed/img/202109191520567.png)
...
![image-20210726094111437](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed/img/202109191520648.png)

在`getHostAddress`方法的时候就会直接return null

![image-20210726100205964](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed/img/202109191520465.png)
...
![image-20210728140556468](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed/img/202109191531675.png)
...
![image-20210728115233758](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed/img/202109191531053.png)

通过for循环使前一个Transformer返回的object传入下一个Transformer的transform方法

接下来就是熟悉的通过InvokerTransformer反复去反射Runtime的方法最后执行exec

![image-20210728120142154](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed/img/202109191531475.png)
...
![image-20210728152028408](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed/img/202109191531558.png)
...
![image-20210728160825189](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed/img/202109191532224.png)
...
- `outerMap.remove("keykey");`
  ...
  ![image-20210804170742116](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed/img/202109191532839.png)
...
![image-20210805140305820](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed/img/202109191532539.png)
...
![image-20210805143152300](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed/img/202109191532454.png)
...
![image-20210809135002812](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed/img/202109191532991.png)
...
![image-20210809135418059](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed/img/202109191532319.png)
