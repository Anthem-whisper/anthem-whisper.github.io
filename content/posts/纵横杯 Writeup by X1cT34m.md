...
![image-20201226234822836](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed@main/img/20210104164407.png)
...
![image-20201226235325587](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed@main/img/20210104164406.png)

扫目录可以扫到很多json，里面含有一些组件信息

![image-20201226235519551](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed@main/img/20210104165914.png)

不过查看了一下，这个框架这个版本目前是没有符合情景的漏洞的；

![image-20201226235633677](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed@main/img/20210104165741.png)
...
![image-20201227000708960](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed@main/img/20210104164649.png)

没错，web路径就是`/var/sercet/html/`，用`0'||ascii(substr((select load_file('/var/sercet/html/index.php')),1,1))>79#`可以读取index.php的源码：

![image-20201227001109957](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed@main/img/20210104164653.png)
...
![](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed@main/img/20210104164657.png)

发现是yzmcms

`common\config\config.php`看到数据库配置

![](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed@main/img/20210104164707.png)
...
![](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed@main/img/20210104164715.png)

在后台的模块管理->采集管理模块处添加节点，然后网址处填写构造的恶意页面

跟进`collection`类，转到`yzmphp\core\class\collection.class.php`：

![](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed@main/img/20210104164720.png)
...
![](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed@main/img/20210104164727.png)


配置如下：

![image-20201226151910969](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed@main/img/20210104164731.png)

成功读取：
![](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed@main/img/20210104164736.png)

尝试读flag:
```html
<leon><a href="httpxxx://../../../../../../flag">123</a></leon>
```
![](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed@main/img/20210104164739.png)
...
![](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed@main/img/20210104164743.png)
...
![](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed@main/img/20210104164749.png)
...
![](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed@main/img/20210104165117.png)

直接没有waf的写入，并且是往一个php文件里面写，由于一些变量可控让我们可以代码注入
![](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed@main/img/20210104165126.png)

admin\admin登陆后台；
![](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed@main/img/20210104165134.png)

之后访问admin_smtp.php，在点击“确认”的时候抓取数据包，改包：

![](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed@main/img/20210104164813.png)



直接来一发：
![](https://cdn.jsdelivr.net/gh/Anthem-whisper/imgbed@main/img/20210104165144.png)
